...
export const STARTER_TEMPLATES: Template[] = [
  ...
  {
    name: 'Fullstack SaaS',
    label: 'Full-Stack SaaS (Auth + Supabase)',
    description: 'Vite React app with Supabase auth, protected routes, and dashboard shell',
    githubRepo: 'xKevIsDev/bolt-vite-react-ts-template',
    tags: ['react', 'vite', 'supabase', 'auth', 'saas', 'fullstack'],
    icon: 'i-bolt:react',
  },
  {
    name: 'Vite React',
